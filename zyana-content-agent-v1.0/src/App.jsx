              ...
              {items.map(({ id, label, icon: Icon, badge }) => {
                ...
                return (
                  ...
                  >
                    ...
                    {badge && !active && (
                      <span className="text-[8px] font-syne font-bold bg-gold-500/20 text-gold-500 px-1.5 py-0.5 rounded-full leading-none">
                        {badge}
                      </span>
                    )}
                  </button>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#0E0E11] border border-white/10 rounded-2xl max-w-lg w-full p-8 fade-in-up">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-gold-500 to-gold-600 text-black font-syne font-bold rounded-xl py-3 hover:opacity-90 transition-opacity"
            >
